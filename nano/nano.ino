...
int state = 0 , loadstate = EEPROM.read(1);
int distance = 15;
int distance_one = 53;
int global = 0;
int switch_valu = 2;
...
void loop() {
  ...
  */
  ...
  if ( sval3 == HIGH ){
    fan_var =! fan_var;
    EEPROM.write(0, fan_var);
    Serial.print("The state of fan is ");
    Serial.println(fan_var);
    delay(120);
  }
